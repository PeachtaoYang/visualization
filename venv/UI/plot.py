...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_4.setText(_translate("Dialog", "线条风格："))
        self.label_5.setText(_translate("Dialog", "线条宽度："))
        self.label_6.setText(_translate("Dialog", "标记风格："))
        self.label_8.setText(_translate("Dialog", "标记尺寸："))
